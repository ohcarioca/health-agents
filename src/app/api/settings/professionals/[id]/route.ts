...
export async function PUT(
  ...
  if (parsed.data.specialty !== undefined)
    updateData.specialty = parsed.data.specialty || null;
  if (parsed.data.appointment_duration_minutes !== undefined)
  ...
  if (parsed.data.registration_number !== undefined)
    updateData.registration_number = parsed.data.registration_number || null;
